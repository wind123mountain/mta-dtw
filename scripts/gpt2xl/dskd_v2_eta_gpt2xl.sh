...
# we use qwen-2.5-7b-instruct as the teacher with the different vocabulary from gpt2
...
CONFIG="lora-rank=${LORA_RANK}-alpha=${LORA_ALPHA}-dropout=${LORA_DROPOUT}-${KD_OBJ}-${PRECISION}"
